...
public class GraphicsUtil {
     ...
     * would be nice, but you cannot just do it by
     ...
     * thickness. left/top are the <B>center</B> of the lines drawn. Ie
     * width/height are from the center of one side to the center of the other.
     * So the inside width/heights are really lineWidth less than the values
     * of width and height; the outside width/heights are lineWidth more.
     *
     * @param g         The Graphics object.
     * @param left      Center of left side edge.
     * @param top       Center of the top edge.
    ...
    /**
     * Draws a 3D rectangle in the specified location with the given line
     * thickness and color. left/top are the <B>center</B> of the lines drawn.
     * Ie width/height are from the center of one side to the center of the
     * other. So the inside width/heights are really lineWidth less than
     * the values of width and height; the outside width/heights are
     * lineWidth more.
     *
     * @param g         The Graphics object.
     * @param left      Center of left side edge.
    ...
    /**
     * Draws a 1-pixel thick 3D rectangle in the specified location with the
     * given color.
     *
     * @param g        The Graphics object.
     * @param left     The x-coordinate of left side edge.
    ...
    /**
     * Calls g.drawString(s, x, y) after setting the color to c. Resets the
     * color after drawing.
     *
     * @param g The Graphics object.
    ...
    /**
     * Calls g.drawString(s, x, y) after setting the font to f. Resets the
     * font after drawing.
     *
     * @param g The Graphics object.
     * @param s The string to be drawn.
    ...
    /**
     * Calls g.drawString(s, x, y) after setting the font to f and the color
     * to c. Resets the font and color after drawing.
     *
     * @param g The Graphics object.
     * @param s The string to be drawn.
     * @param x The left side of the string
